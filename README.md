...
5.Armstrong number.(ex.153 1^3+5^3+3^3==153 the sum of the digit raised to the power of number of digit=the number itself.)
6.Menu driven program for finding largest of two and three number.